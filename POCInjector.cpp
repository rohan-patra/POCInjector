...
int main(int argc, char* argv[])
{
	...
	printf("Injector Created By Rohan Patra");
	...
	std::wstring wsTmp(dllname.begin(), dllname.end());
	hFile = CreateFile(wsTmp.c_str(), GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL); // Open the DLL
